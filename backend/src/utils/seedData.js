...
export const seedSkills = [
  ...
  { name: 'Java', logo: 'https://cdn.simpleicons.org/openjdk/EA2D2E', description: 'Core Java programming and object-oriented application development.', category: 'Languages', order: 4 },
  ...
  { name: 'PHP', logo: 'https://cdn.simpleicons.org/php/777BB4', description: 'Server-side scripting for dynamic web applications.', category: 'Languages', order: 6 },
  ...
  { name: 'Django', logo: 'https://cdn.simpleicons.org/django/092E20', description: 'Python framework for secure and rapid backend development.', category: 'Backend', order: 11 },
  ...
  { name: 'MySQL', logo: 'https://cdn.simpleicons.org/mysql/4479A1', description: 'Relational database design and SQL query optimization.', category: 'Databases', order: 13 },
