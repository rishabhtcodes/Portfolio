  ...
  return (
    <div className="min-h-screen bg-slate-50 px-6 py-10 text-slate-900">
      <div className="mx-auto flex min-h-[85vh] max-w-6xl items-center justify-center">
        <div className="grid w-full max-w-5xl overflow-hidden rounded-[2rem] border border-slate-200/50 bg-white/60 shadow-glass backdrop-blur-xl lg:grid-cols-[1.05fr_0.95fr]">
          <div className="hidden flex-col justify-between border-r border-slate-200/50 bg-gradient-to-br from-rose-500/12 via-slate-900 to-red-500/12 p-10 lg:flex">
            <div>
            ...
            <p className="text-sm text-slate-500">Node.js, Express, MongoDB Atlas, JWT auth, and a React admin dashboard.</p>
          </div>
          ...
          <div className="p-6 sm:p-10">
            <div className="mx-auto max-w-md">
              ...
              <p className="mt-3 text-sm leading-7 text-slate-600">Use the admin credentials configured in your backend environment to unlock the dashboard.</p>

              <form onSubmit={handleSubmit} className="mt-8 space-y-5">
                <div>
                  <label className="mb-2 block text-sm font-medium text-slate-700" htmlFor="admin-email">Email</label>
                  <input
                    id="admin-email"
                    type="email"
                    value={email}
                    onChange={(event) => setEmail(event.target.value)}
                    className="w-full rounded-2xl border border-slate-200/50 bg-white/70 px-4 py-3 text-sm text-slate-900 outline-none transition focus:border-rose-300/40"
                ...
                <div>
                  <label className="mb-2 block text-sm font-medium text-slate-700" htmlFor="admin-password">Password</label>
                  <input
                    id="admin-password"
                    type="password"
                    value={password}
