          ...
          return (
            ...
            >
              <div className="flex items-start justify-between gap-4">
                <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-sky-400/15 to-indigo-400/15 text-sky-200">
              ...
              <h3 className="mt-5 text-lg font-semibold text-white">{cert.title}</h3>
