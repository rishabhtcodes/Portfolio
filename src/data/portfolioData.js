...
export const certificates = [
  ...
  },
  {
    ...
    issuer: 'Google Coursera',
    date: 'Oct 2024',
    credentialId: 'COURSERA-PYTHON-2024',
    credentialLink: 'https://coursera.org/learn/google-python',
    icon: Award,
  },
  {
    ...
    date: 'Nov 2024',
    credentialId: 'COURSERA-DJANGO-2024',
    credentialLink: 'https://coursera.org/learn/django-web-framework',
    icon: Award,
  },
  {
    ...
    issuer: 'Meta Coursera',
    date: 'Dec 2024',
    credentialId: 'COURSERA-FE-CAPSTONE-2024',
    credentialLink: 'https://coursera.org/learn/meta-front-end-developer-capstone',
    icon: Award,
  },
  {
    ...
    issuer: 'IBM Coursera',
    date: 'Jan 2025',
    credentialId: 'COURSERA-NODE-EXPRESS-2025',
    credentialLink: 'https://coursera.org/learn/developing-backend-apps-nodejs-express',
    icon: Award,
  },
  {
    ...
    issuer: 'IBM Coursera',
    date: 'Feb 2025',
    credentialId: 'COURSERA-RDBMS-2025',
    credentialLink: 'https://coursera.org/learn/introduction-to-relational-databases',
    icon: Award,
  },
  {
    ...
    date: 'Mar 2025',
    credentialId: 'COURSERA-DSA-CPP-2025',
    credentialLink: 'https://coursera.org/learn/data-structures-algorithms-cpp',
    icon: Award,
  },
  {
    ...
    date: 'Apr 2025',
    credentialId: 'COURSERA-GIT-2025',
    credentialLink: 'https://coursera.org/learn/version-control-git',
    icon: Award,
  },
  {
    ...
    date: 'May 2025',
    credentialId: 'LF-DOCKER-2025',
    credentialLink: 'https://training.linuxfoundation.org/training/docker-for-developers',
    icon: Award,
  },
];
